...
public class BlufiModule extends ReactContextBaseJavaModule {
    ...
    public void requestDeviceWifiScan(Promise promise) {
        ...
        // Also trigger phone-side scan as backup
        scanPhoneWifi(); 
        promise.resolve(true);
    }
        ...
        if (wifiManager != null) {
             try {
                ...
                wifiManager.startScan();
                 ...
                 sendLog("Phone scan failed: " + e.getMessage());
             }
        }
    }
    ...
    private class BlufiCallbackMain extends BlufiCallback {
        ...
        public void onGattPrepared(BlufiClient client, BluetoothGatt gatt, BluetoothGattService service, BluetoothGattCharacteristic writeChar, BluetoothGattCharacteristic notifyChar) {
            sendLog("Gatt Prepared. Requesting MTU 512...");
        ...
        public void onDeviceVersionResponse(BlufiClient client, int status, BlufiVersionResponse response) {
            ...
            if (response != null) {
                sendLog("Version: " + response.getVersionString());
            }
        }
        ...
        public void onDeviceScanResult(BlufiClient client, int status, List<BlufiScanResult> results) {
            ...
            if (status == 0 && results != null) {
                ...
                // Important: Emit as 'BlufiDeviceScanResult' to match shared logic
                sendEvent("BlufiDeviceScanResult", params); 
                sendLog("Device Scan: Found " + results.size() + " networks");
            }
        }
        ...
        public void onError(BlufiClient client, int errCode) {
             if (errCode != 0) sendStatus("Error: " + errCode);
        }
    }
